...
static const int LAST_POW_BLOCK = 262800; //POW block reward:  8 LGC
...
static const uint256 hashGenesisBlock("0x0000103b70ac621e0afca306129edd44d7e2a661e42bf96f54b905a047c8c8f7");
static const uint256 hashGenesisBlockTestNet("");
inline int64_t PastDrift(int64_t nTime)   { return nTime - 20 * 60 * 60; } // up to 10 hours from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 20 * 60 * 60; } // up to 10 hours from the future
