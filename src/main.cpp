...
int64_t nTargetSpacing = 3 * 60;  // Time between reward:    120 Second
...
// miner's coin base reward premine -- Premined: 5.500.000
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "legendcoin.com Block";
        CTransaction txNew;
        txNew.nTime = 1514171993;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1514171993;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2306485;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0202a73af66f7e834e740313c2894836d77d04a5a6eb7c0baf42ee6f03d7256f"));
        block.print();
